...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-12">
			<p class="lead">Produit ???</p>

		</div>
		Informations complétes sur le produit
		...
		Afficher les commentaires/notes avec moyenne
<br>
<br>
//Système de commentaire, ajouter les étoiles
Cacher le champs pseudo, supprimer le champs email, ajout du système des étoiles
Revoir le css
		<style type="text/css">
			#contact{
				padding:10px 0 10px;
